                        ...
                        <div class="card-inner">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tabItem5">
                                    <div class="gy-3">
                                        <form action="<?php echo e(url('dashboard/settings/site')); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>"
                                                                name="name" value="<?php echo e(appSetting()->name); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                                                name="keyword" value="<?php echo e(appSetting()->keyword); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row g-3 align-center">
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <input type="text"
                                                                class="form-control <?php $__errorArgs = ['tagline'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                                name="tagline" value="<?php echo e(appSetting()->tagline); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
unset($__errorArgs, $__bag); ?>" name="description"
                                                                value="<?php echo e(appSetting()->description); ?>"><?php echo e(appSetting()->description); ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                                                name="logo" value="<?php echo e(appSetting()->logo); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane" id="tabItem6">
                                    <div class="gy-3">
                                        <form action="<?php echo e(url('dashboard/settings/contact')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-5">
                                                    <div class="form-group">
...
unset($__errorArgs, $__bag); ?>"
                                                                name="phone" value="<?php echo e(appSetting()->phone); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                                                name="email" value="<?php echo e(appSetting()->email); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                                                name="address" value="<?php echo e(appSetting()->address); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row g-3 align-center">
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <input type="text"
                                                                class="form-control <?php $__errorArgs = ['ig'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                                name="ig" value="<?php echo e(appSetting()->ig); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row g-3 align-center">
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <input type="text"
                                                                class="form-control <?php $__errorArgs = ['fb'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                                name="fb" value="<?php echo e(appSetting()->fb); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                                                name="twitter" value="<?php echo e(appSetting()->twitter); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('admin.layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\TUBES WAD\telshop\resources\views/admin/pages/settings/index.blade.php ENDPATH**/ ?>