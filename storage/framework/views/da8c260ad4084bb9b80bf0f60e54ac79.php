                        ...
                        <div class="slick-single-layout">
                            <div class="categrie-product" data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500">
                                <a href="<?php echo e(url('category/' . $item->slug)); ?>">
                                    <h6 class="cat-title"><?php echo e($item->name); ?></h6>
                                </a>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center mt--20 mt_sm--0">
                        <a href="<?php echo e(url('products')); ?>" class="axil-btn btn-bg-lighter btn-load-more">Lihat Semua</a>
                    </div>
                </div>
...
<?php echo $__env->make('client.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\S4\PAW\telshop\resources\views/client/homepage.blade.php ENDPATH**/ ?>