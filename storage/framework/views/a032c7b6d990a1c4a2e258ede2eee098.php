            ...
            <div class="nk-block nk-block-lg">
                ...
                <div class="card">
                    <div class="card-inner">
                        <form action="<?php echo e(url('dashboard/products')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" class="form-select js-select2 <?php $__errorArgs = ['category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> summernote" rows="4"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('stock')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-select js-select2 <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('admin.layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\TUBES WAD\telshop\resources\views/admin/pages/products/create.blade.php ENDPATH**/ ?>