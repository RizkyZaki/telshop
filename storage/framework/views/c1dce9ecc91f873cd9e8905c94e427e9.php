            ...
            <div class="nk-block nk-block-lg">
                ...
                <div class="card">
                    <div class="card-inner">
                        <form action="<?php echo e(url('dashboard/products/' . $product->slug)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php if($product->image): ?>
                                    <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" width="120" class="mb-2">
                                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <button type="submit" class="btn btn-primary mt-2">Update Produk</button>
                        </form>
                    </div>
                </div>
            </div>
