    ...
    <div class="nk-sidebar-element nk-sidebar-head">
        <div class="nk-sidebar-brand">
            <a href="javascript:void(0);" class="logo-link nk-sidebar-logo" >
               <img class="logo-light logo-img" src="<?php echo e(asset('storage/assets/site/logo/' . appSetting()->logo)); ?>"
                    srcset="<?php echo e(asset('storage/assets/site/logo/' . appSetting()->logo)); ?>" alt="logo">
                <img class="logo-dark logo-img" src="<?php echo e(asset('storage/assets/site/logo/' . appSetting()->logo)); ?>"
                    srcset="<?php echo e(asset('storage/assets/site/logo/' . appSetting()->logo)); ?>" alt="logo-dark">
            ...
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item">
                        <a href="<?php echo e(url('dashboard/overview')); ?>" class="nk-menu-link">
                    ...
                    <li class="nk-menu-item">
                        <a href="<?php echo e(url('dashboard/category')); ?>" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-tags"></em></span>
                            <span class="nk-menu-text">Kategori</span>
                        </a>
                    </li>
                    <li class="nk-menu-item">
                        <a href="<?php echo e(url('dashboard/products')); ?>" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-bag"></em></span>
                            <span class="nk-menu-text">Produk</span>
                        </a>
                    </li>
                    <li class="nk-menu-item">
                        <a href="<?php echo e(url('dashboard/users')); ?>" class="nk-menu-link">
                    ...
                    <li class="nk-menu-item">
                        <a href="<?php echo e(url('dashboard/settings')); ?>" class="nk-menu-link">
...
<?php /**PATH D:\School\S4\PAW\telshop\resources\views/admin/components/_sidebar.blade.php ENDPATH**/ ?>